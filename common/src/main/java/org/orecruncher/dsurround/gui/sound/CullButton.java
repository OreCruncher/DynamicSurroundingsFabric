...
public class CullButton extends ToggleButton {
    ...
    private static final ResourceLocation CULL_ON_SYMBOL = Constants.asId("controls/cull_on");
    private static final ResourceLocation CULL_OFF_SYMBOL = Constants.asId("controls/cull_off");
