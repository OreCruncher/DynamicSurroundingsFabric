...
public class CullButton extends ToggleButton {
    ...
    private static final Identifier CULL_ON_SYMBOL = Identifier.fromNamespaceAndPath(Library.MOD_ID, "controls/cull_on");
    private static final Identifier CULL_OFF_SYMBOL = Identifier.fromNamespaceAndPath(Library.MOD_ID, "controls/cull_off");
