...
public class SoundPlayButton extends ToggleButton {
    ...
    private static final ResourceLocation PLAY_SYMBOL = Constants.asId("controls/play");
    private static final ResourceLocation STOP_SYMBOL = Constants.asId("controls/stop");
