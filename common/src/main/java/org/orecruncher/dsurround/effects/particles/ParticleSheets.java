...
public final class ParticleSheets {
    ...
    public static final ResourceLocation TEXTURE_WATER_RIPPLE_PIXELATED_CIRCLE = ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "textures/particles/pixel_ripples.png");
